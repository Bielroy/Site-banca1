...
// UX & FEEDBACK TÁTIL (Mobile Premium)
...
// CONTROLADORES DE MODAL (History API + Acessibilidade)
export const openModal = (id) => {
    const modal = document.getElementById(id);
    if(modal) {
        modal.classList.add('aberto');
        modal.setAttribute('aria-hidden', 'false');
        document.body.style.overflow = 'hidden'; // Previne double-scroll mobile
...
// PROMISE-BASED CONFIRMATION MODAL (Reutilizável)
